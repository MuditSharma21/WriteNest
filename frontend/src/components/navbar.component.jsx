...
import darkLogo from "../imgs/writenest-dark.png";
import lightLogo from "../imgs/writenest-light.png";
...
const Navbar = () => {
  ...
  const changeTheme = () => {
    ...
    localStorage.setItem("writenest-theme", newTheme);
  };

  return (
    <nav className="navbar z-50">
      <Link to="/" className="flex-none w-10">
        <img src={theme == "light" ? lightLogo : darkLogo} alt="logo" style={{ height: '60px' }} />
      </Link>
